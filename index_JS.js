const API_KEY = "7bf08bc3329e50005328e6b609b7edea";
...
function jarvisStartingReply() {
  Speak(
    "please wait...system initializing...backing up configurations...gathering audio and video files..."
  );
  Speak("system initialized...");
  Speak(
    "i am online and ready... say push enable to talk... or simply click arc reactor..."
  );
  startListening();
}
